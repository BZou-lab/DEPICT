...
CSV_PATH            = Path("./RawData/compounds_df_wTarMoA_part1.csv")          # full dataset
...
compounds_info_part1 = pd.read_csv(
    CSV_PATH,
    index_col=0,
...
try:
    ...
    iterator = tqdm(compounds_info_part1.itertuples(index=False), total=len(compounds_info_part1))
except ImportError:
    iterator = compounds_info_part1.itertuples(index=False)
...
compounds_info_part1["augmented_yaml"] = yaml_list

compounds_info_part1.to_csv("./RawData/compounds_with_yaml_part1.csv", index=False)
