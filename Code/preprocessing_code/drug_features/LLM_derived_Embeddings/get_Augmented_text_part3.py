...
CSV_PATH            = Path("./RawData/compounds_df_wTarMoA_part3.csv")          # full dataset
...
compounds_info_part3 = pd.read_csv(
    CSV_PATH,
    index_col=0,
...
try:
    ...
    iterator = tqdm(compounds_info_part3.itertuples(index=False), total=len(compounds_info_part3))
except ImportError:
    iterator = compounds_info_part3.itertuples(index=False)
...
compounds_info_part3["augmented_yaml"] = yaml_list

compounds_info_part3.to_csv("./RawData/compounds_with_yaml_part3.csv", index=False)
