...
if __name__ == "__main__":
    ...
    os.makedirs(f'./Code/other_models/PRNet/results/lincs/final_results/{args_train.split_key}/first50ep', exist_ok=True)
    ...
    config_kwargs = {
        ...
        'results_dir' : f'./Code/other_models/PRNet/results/lincs/final_results/{args_train.split_key}/first50ep',
        'n_epochs' : 100,
