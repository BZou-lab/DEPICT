...
def parse_args():
    ...
    parse.add_argument('--split_key', default='cell_split2', type=str, help='split key of data')  
...
if __name__ == "__main__":
    ...
    # ensure dirs exist (no new variables)
    os.makedirs(f'./Code/other_models/PRNet/results/lincs/final_results/{args_train.split_key}/rest50ep/', exist_ok=True)
    os.makedirs('./Code/other_models/PRNet/checkpoint/final_run', exist_ok=True)
    

    config_kwargs = {
        'batch_size' : 512,
        'comb_num' : 1,
        'save_dir' : './Code/other_models/PRNet/checkpoint/final_run/',
        'results_dir' : f'./Code/other_models/PRNet/results/lincs/final_results/{args_train.split_key}/rest50ep/',
        'n_epochs' : 100,
    ...
    adata = sc.read('./Data/FinalData/dataset/adataAfterClean.h5ad')
    ...
    Trainer.test(f'./Code/other_models/PRNet/checkpoint/final_run/{args_train.split_key}_best_epoch_all.pt')
